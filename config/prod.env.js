...
module.exports = {
  ...
  // 生产环境
  // 站点域名
  WEB_HOST: '"https://badmin.kangmei.com.cn/#"',
  // .net 接口 默认host
  BASE_HOST: '"https://adbqapi.kangmei.com.cn"',
  // java 电商模块 默认host
  ...
  // 测试环境
  // 站点域名
  // WEB_HOST: '"https://tbadmin.kangmeiyaohulu.com/#"',
  // // .net 接口 默认host
  // BASE_HOST: '"https://tadbqapi.kangmeiyaohulu.com"',
  // // java 电商模块 默认host
