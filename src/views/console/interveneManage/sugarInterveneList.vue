<template>
  <div id="archives_box">
    ...
    <el-dialog title="查看详情" :visible.sync="visceraDetail" width="60%" :center="true" :modal-append-to-body="false" class="details">
      <el-row><el-col :span="24"><div class="grid-content bg-purple commonH"><span class="strong">血糖范围</span>{{detailData.name}}</div></el-col></el-row>
...
export default {
  ...
  computed: {
    columns() {
      ...
      let columns = [
        ...
        { field: 'name', title: '血糖范围', width: 150, titleAlign: 'center', columnAlign: 'center', isResize: true, overflowTitle: true },
  ...
  methods: {
    // 新增
    addData() {
      this.$router.push('/interveneManage/addIntervene?type=' + 5);
    },
    // 导入
    Import() {
