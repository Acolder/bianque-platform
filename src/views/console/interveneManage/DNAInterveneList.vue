<template>
  <div id="archives_box">
    ...
    <el-dialog title="查看详情" :visible.sync="visceraDetail" width="60%" :center="true" :modal-append-to-body="false" class="details">
      <el-row><el-col :span="24"><div class="grid-content bg-purple commonH"><span class="strong" style="width:95px;display:block;margin-right:12px;">疾病名称</span>{{detailData.name}}</div></el-col></el-row>
      <el-row><el-col :span="24"><div class="grid-content bg-purple commonH"><span class="strong">平均风险值</span>{{detailData.range_max}}</div></el-col></el-row>
      ...
      <el-row><el-col :span="24">
        <div class="grid-content bg-purple commonH"><span class="strong">评估结果</span><div class="common" v-html="detailData.symptom"></div></div>
      </el-col></el-row><br/>
      <el-row>
        <el-col :span="24">
          <div class="grid-content bg-purple commonH"><span class="strong">健康建议</span><div class="common" v-html="detailData.suggestion"></div></div>
        </el-col>
      </el-row><br/>
      <!-- 中成药调理 -->
      <el-row>
...
export default {
  ...
  computed: {
    columns() {
      ...
      let columns = [
        ...
        { field: 'name', title: '疾病名称', width: 150, titleAlign: 'center', columnAlign: 'center', isResize: true, overflowTitle: true },
        // { field: 'range_max', title: '平均风险值', width: 150, titleAlign: 'center', columnAlign: 'center', isResize: true, overflowTitle: true },
        { field: 'symptom', title: '评估结果', width: 250, titleAlign: 'center', columnAlign: 'center', isResize: true, overflowTitle: true },
  ...
  methods: {
    // 新增
    addData() {
      this.$router.push('/interveneManage/addIntervene?type=' + 7);
    },
    // 导入
    Import() {
