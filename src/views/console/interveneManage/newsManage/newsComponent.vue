  ...
  methods: {
    ...
    getColumns() {
      ...
      let columns = [
        ...
        { field: 'operation', title: '操作', width: 200, titleAlign: 'center', columnAlign: 'center', componentName: 'table-operations-qrxz', isResize: true }
      ];
    ...
    customCompFunc(params) {
      if (params.type === 'true') {
        parent.window.oneNews(params.rowData);
      }
    },
    // 分页
