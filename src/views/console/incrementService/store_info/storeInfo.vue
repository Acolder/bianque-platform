<template>
  <div id="programmeWrap">
    <el-form ref="programme" :model="programmeForm" :rules="rules" label-width="100px">
      ...
      <el-row>
        <el-col :span="24" >
          <el-form-item label="地址" class="provincename">
      ...
      <el-row>
        <el-col :span="24" >
          <el-form-item label="所在地点" prop="location" class="locationWrap">
            ...
            <el-button icon="el-icon-location" @click="chooseAddress" class="location">选择地址</el-button>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
    ...
    ready(longitude, latitude) {
      ...
      function showInfo(e) {
        ...
        // addressComponents对象可以获取到详细的地址信息
          ...
          _self.programmeForm.city = addComp.city;
          _self.programmeForm.area = addComp.district;
