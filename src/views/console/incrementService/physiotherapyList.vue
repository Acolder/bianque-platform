  ...
  <div class="physiotherapy">
    <div class="search-wrapper">
      <el-form :inline="true" :model="screenInfo" size="small" >
        <el-form-item label="门店名称：">
          <el-input v-model="screenInfo.name" placeholder="请输入门店名称" clearable></el-input>
        </el-form-item>
    ...
    <el-dialog title="门店详情" :visible.sync="storeDetailShow" width="600px" :center="true" :modal-append-to-body="false" :append-to-body="true" class="details">
      ...
      <el-row>
        <el-col :span="24">
          <div class="grid-content bg-purple commonH">
            <span class="strong">地区： </span> {{detailData.province}}
          </div>
        </el-col>
      </el-row>
      <el-row>
...
export default {
  ...
  computed: {
    getColunms() {
      ...
      let columns = [
        ...
        { field: 'operation', title: '操作', width: 300, titleAlign: 'center', columnAlign: 'center', componentName: 'table-operation-storeList', isResize: true }
      ];
  ...
  methods: {
    ...
    // 新增门店信息
    add() {
      this.$router.push('/incrementService/store_info/addStore');
    },
    // 删除单个数据
    remove(id) {
      let _self = this;
    ...
    customCompFunc(params) {
      if (params.type === 'remove') {  // 删除
        ...
        this.$router.push('/incrementService/store_info/editStore?id=' + params.rowData.id);
