<template>
  <div class="Viscera">
      <div class="table-wrapper">
        <v-table ref="data_table" column-width-drag :is-horizontal-resize="true" style="width:100%" :columns="getColumns" :table-data="tableData" row-hover-color="#eee"
  ...
  computed: {
    ...
    getColumns() {
      ...
      let columns = [
        ...
        { field: 'operation', title: '操作', width: 200, titleAlign: 'center', columnAlign: 'center', componentName: 'outNewList', isResize: true }
      ];
    ...
    getTableData() {
      ...
      ajax.post(`/api/jinmu/GetContentDescribePageList`, param).then((res) => {
        if (res.status === 200 && res.data.code === 0) {
          ...
          _self.tableData = res.data.data.rdetails;
        }
      });
    },
    // table operaion
