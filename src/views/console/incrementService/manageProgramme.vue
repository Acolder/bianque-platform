...
export default {
  ...
  computed: {
    ...
    conditioningColumns() {
      ...
      let columns = [
        ...
        // { field: 'title', title: '商品ID', width: 120, titleAlign: 'center', columnAlign: 'center', isResize: true },
  ...
  methods: {
    ...
    remove(id) {
      let _self = this;
      ajax.get(`/api/borrow/DelPhysiotherapyStoreProgrammeInfoByid/` + id).then((res) => {
