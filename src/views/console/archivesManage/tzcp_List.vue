...
export default {
  ...
  computed: {
    columns() {
      ...
      let columns = [
        ...
        { field: 'constitution', title: '体质测评结果', width: 100, titleAlign: 'center', columnAlign: 'center', isResize: true, overflowTitle: true },
  ...
  methods: {
    getTableData() {
      ...
      ajax.get(`/api/admin/GetUserConstitutionLogInfoByid/` + param.km_userid + '/' + param.pageIndex + '/' + param.pageSize).then(res => {
        console.log(res);
