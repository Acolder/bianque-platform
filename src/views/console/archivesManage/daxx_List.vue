...
export default {
  ...
  computed: {
    columns() {
      ...
      let columns = [
        ...
        { field: 'gender', title: '性别', width: 100, titleAlign: 'center', columnAlign: 'center', isResize: true, overflowTitle: true },
        { field: 'age', title: '年龄', width: 120, titleAlign: 'center', columnAlign: 'center', isResize: true, overflowTitle: true },
        { field: 'height', title: '身高', width: 60, titleAlign: 'center', columnAlign: 'center', isResize: true, overflowTitle: true },
        { field: 'weight', title: '体重', width: 60, titleAlign: 'center', columnAlign: 'center', isResize: true, overflowTitle: true },
  ...
  methods: {
    getTableData() {
      ...
      ajax.get(`/api/admin/GetUserBaseLogInfoByid/` + param.km_userid + '/' + param.pageIndex + '/' + param.pageSize).then(res => {
